...
| [A4](a4-cold-resume-compaction-investigation.md) | Cold-resume Compaction 调查 | 🔧 方案 A 已实现（分支 `a4-cold-compact`），待部署与运行时验证 | 11 | — | 见 §3 与 [a4-code-findings.md](a4-code-findings.md) |
