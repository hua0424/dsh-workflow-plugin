...
| T4 | [#11](https://github.com/hua0424/dsh-workflow-plugin/issues/11) | 同节点返工、历史与争议协调 | #10 | follow-up完成，待重新关闭 |
| T5 | [#13](https://github.com/hua0424/dsh-workflow-plugin/issues/13) | Role 复用、compact 与安全收口 | #11 | 阻塞（T4重开） |
...
- T5 后续起始点以本次T4 follow-up提交为准。标准Web的jobs/compaction按required service接入正式类型；不同时维护optional路径。
